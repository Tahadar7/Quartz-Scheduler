...
public class CreateEmailJobRequestValidator : AbstractValidator<CreateEmailJobRequest>
{
    public CreateEmailJobRequestValidator()
    {
        RuleFor(x => x.JobName)
    ...
    // Quartz validates its own cron syntax
